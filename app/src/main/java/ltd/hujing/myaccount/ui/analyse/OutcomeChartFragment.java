    ...
    private class MyRecycleViewAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            if (viewType == ITEM_TYPE_HEADER){
                view = LayoutInflater.from(OutcomeChartFragment.this.getContext()).inflate(R.layout.item_analysefrag_header,parent,false);
                return new HeaderHolder(view) ;
            }else{
                view = LayoutInflater.from(OutcomeChartFragment.this.getContext()).inflate(R.layout.item_analysefrag_lv,parent,false);
...
//        获取这个月每天的支出总金额，
                List<BarChartItemBean> list = DBManager.getSumMoneyOneDayInMonth(year, month, 0);
                if (list.size() == 0) {
...
//                初始化每一根柱子，添加到柱状图当中
            ...
            protected void setYAxis(int year, int month) {
                ...
                double maxMoney =  DBManager.getMaxMoneyOneDayInMonth(year, month, 0);
